...
const TIMELINE: Beat[] = [
  ...
  { t: 7180, type: "banner", text: "critical hit" },
  ...
  { t: 8950, type: "banner", text: "Veil — Ultimate" },
...
export function Battle() {
  ...
  return (
    <div className={`${styles.viewport} ${shakeClass}`}>
      <div className={styles.viewportHead}>
        <span className={styles.viewportTitle}>
          <span className={styles.dot} aria-hidden /> live duel
        </span>
  ...
  return (
    <div className={`${styles.hpBar} ${tone}`}>
      <div className={styles.hpLabel}>
        ...
        <span className={styles.hpValue}>{Math.round(hp)} / 100</span>
      </div>
