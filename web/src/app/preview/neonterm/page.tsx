...
export const metadata: Metadata = {
  title: "preview / neonterm",
  description: "Neon-terminal — V1 atmosphere with V4 palette.",
};

export default function NeonTermPreviewPage() {
  return (
    <div className={`${styles.shell} ${display.variable} ${body.variable}`}>
      {/* Boot line */}
      <div className={styles.bootLine}>
        <span className={styles.prompt}>codetama@neonnet:~$</span>
        <span className={styles.bootText}>./codetama --hero --net</span>
      ...
      <section className={styles.hero}>
        <div className={styles.titleBlock}>
          ...
          <h1 className={styles.title}>
            <span className={styles.titleA}>a creature</span>
            <span className={styles.titleB}>that lives</span>
            <span className={styles.titleC}>in your code.</span>
          </h1>

          <p className={styles.lede}>
            Hooks into Claude Code. Every prompt feeds it. Every tool you reach for shapes
            its character. Forget about it for a week and it dies. Battle other devs over{" "}
      ...
      <section className={styles.section}>
        <div className={styles.sectionLabel}>
          ...
          <span className={styles.sectionLabelText}>01 // boot sequence</span>
      ...
      <section className={styles.section}>
        <div className={styles.sectionLabel}>
          <span className={styles.sectionLabelMark}>┌─</span>
          <span className={styles.sectionLabelText}>02 // class registry</span>
          <span className={styles.sectionLabelLine} aria-hidden />
          <span className={styles.sectionLabelMark}>─┐</span>
        </div>
        <h2 className={styles.sectionTitle}>
      ...
      <section className={styles.section}>
        <div className={styles.sectionLabel}>
          <span className={styles.sectionLabelMark}>┌─</span>
          <span className={styles.sectionLabelText}>03 // feed matrix</span>
          <span className={styles.sectionLabelLine} aria-hidden />
          <span className={styles.sectionLabelMark}>─┐</span>
        </div>
        <h2 className={styles.sectionTitle}>
          tools become{" "}
          <span className={styles.sectionTitleAccent}>stats.</span>
        </h2>
        <p className={styles.sectionLede}>
      ...
      <section className={styles.section}>
        <div className={styles.sectionLabel}>
          <span className={styles.sectionLabelMark}>┌─</span>
          <span className={styles.sectionLabelText}>04 // origin</span>
          <span className={styles.sectionLabelLine} aria-hidden />
          <span className={styles.sectionLabelMark}>─┐</span>
        </div>
        <h2 className={styles.sectionTitle}>
      ...
      <section className={styles.finalCta}>
        <h2 className={styles.finalCtaTitle}>
          <span className={styles.finalCtaA}>adopt one. </span>
          <span className={styles.finalCtaB}>now.</span>
        </h2>
      ...
      <div className={styles.endLine}>
        <span className={styles.endLineBracket}>//</span>
        &nbsp; end of transmission &nbsp;
        <span className={styles.endLineBracket}>//</span>
      </div>
    </div>
