...
const TIMELINE: Beat[] = [
  { t: 250,  type: "log", text: "> hostile detected: sage" },
  { t: 1100, type: "log", text: "> trickster engaged" },
  ...
  return (
    <div className={`${styles.viewport} ${shakeClass}`}>
      ...
      <div className={styles.frameHead}>
        <span className={styles.frameHeadLeft}>
          <span className={styles.frameHeadDot} aria-hidden /> btl://duel.live
        </span>
        <span className={styles.frameHeadRight}>round {String(iter + 1).padStart(2, "0")}</span>
      </div>
      ...
      <div className={styles.statusBar}>
        ...
        <span><span className={styles.statusPink}>seed</span> 0x4a7c</span>
        <span><span className={styles.statusCyan}>tick</span> {String(iter * 14).padStart(4, "0")}s</span>
